...
class PawnTest {
    ...
    @Test
    void isMoveable_거짓() {
        Location source = new Location("f4");
        Location target = new Location("f6");
        ...
        Assertions.assertFalse(isStartRank);
        Assertions.assertFalse(isAvailableInterval);
    }

    @Test
    void isNoPieceOnTheWay_참() {
        boolean result = true;
        Map<Location, Character> positions = new HashMap<>();
        Location position = new Location("b4");
